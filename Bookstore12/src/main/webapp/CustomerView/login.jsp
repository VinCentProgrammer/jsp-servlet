	...
	<div class=container>
		...
		<main class="form-signin w-100 m-auto">
			...
			<form class="text-center" action="<%=url1%>/customer" method="POST">
				<input type="hidden" name="customer_act" value="login" /> <img
					class="mb-4" src="<%=url%>/img/logo/logo.png" alt="" width="72">
				...
				<button class="w-100 btn btn-lg btn-primary" type="submit">Đăng
					nhập</button>
				<a href="<%=url%>/CustomerView/register.jsp">Đăng ký tài khoản
					mới</a>
