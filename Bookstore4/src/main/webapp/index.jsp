...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-light">
		<div class="container-fluid">
			...
			<img src="https://1.bp.blogspot.com/-f_5JLvF9_gU/YZGM7p_fkFI/AAAAAAAAAVo/zHkM8tD3ioAvD1pFznG1kw-QOmOibu5ywCLcBGAsYHQ/s150/1-removebg-preview.png"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						data-bs-toggle="dropdown" aria-expanded="false"> Thể loại 
						</a>
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div clasrs="carousel-inner">
						<div class="carousel-item active">
							<img src="public/images/slider/1.png" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<img src="public/images/slider/2.png" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<img src="public/images/slider/3.png" class="d-block w-100" alt="...">
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="public/images/product/1.png"
								alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="public/images/product/2.png"
								alt="" ></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Áo thun Pro-S1</a>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top" src="public/images/product/3.png"
								alt="" ></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Áo thun Pro-S1</a>
