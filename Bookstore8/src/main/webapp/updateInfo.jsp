...
<body>
	...
	<div class="container">
		...
		<form class="form" action="update-info" method="POST">
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="mb-3">
						<label for="gender" class="form-label">Giới tính</label> <select
							...
							<option value="Other" <%=gender.equals("Other") ? "selected='selected'" : "" %>>Khác</option>
						</select>
					</div>
					<div class="mb-3">
	...
	%>
	<h1>Vui lòng <a href="login.jsp">đăng nhập</a> </h1>
	<%
	} 
	%>
</body>
