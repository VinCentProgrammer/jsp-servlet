...
<body>
	...
	<div class="container">
		...
		<form class="form" action="../customer" method="POST">
			<input type="hidden" name="customer_act" value="register" />
			<div class="row">
				<div class="col-sm-6">
					<h3>Tài khoản</h3>
					<div class="mb-3">
						<label for="username" class="form-label">Tên đăng nhập <span
							class="red">*</span> <span class="red"><%=usernameError%></span>
						</label> <input type="text" class="form-control" id="username"
							name="username" required="required" value="<%=username%>">
					</div>
					<div class="mb-3">
						<label for="password" class="form-label">Mật khẩu <span
							class="red">*</span> <span class="red"><%=passwordError%></span>
						</label> <input type="password" class="form-control" id="password"
							name="password" required="required" onkeyup="checkPassword()">
					</div>
					<div class="mb-3">
						<label for="passwordConfirm" class="form-label">Nhập lại
							mật khẩu<span class="red">*</span> <span id="errorPass"
							class="red"></span>
				...
				<div class="col-sm-6">
					...
					<hr />
					<div class="mb-3">
						<label for="acceptRules" class="form-label">Đồng ý với <a>điều
								khoản của công ty </a><span id="red">*</span>
						</label> <input type="checkbox" class="form-check-input" id="acceptRules"
							name="acceptRules" required="required"
							onchange="checkAcceptRules()">
					</div>
					<div class="mb-3">
						<label for="acceptMail" class="form-label">Đồng ý nhận
							...
							<%=acceptMail.equals("on") ? "checked='checked'" : ""%>>
					</div>
