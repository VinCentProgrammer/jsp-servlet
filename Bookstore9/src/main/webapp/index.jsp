			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search">
					...
					<a class="btn btn-primary" style="white-space: nowrap;"
						href="CustomerView/login.jsp"> Đăng nhập </a>
					<%
					} else {
					%>
					<div class="row text-center" style="margin-left: 0.25em">
						<div class="dropdown dropstart text-end">
							<button type="button" class="btn btn-primary dropdown-toggle"
								data-bs-toggle="dropdown"><b><%=khachHang.getUsername()%></b></button>
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="#">Đơn hàng của tôi</a></li>
								<li><a class="dropdown-item" href="#">Thông báo</a></li>
								<li><a class="dropdown-item" href="CustomerView/updateInfo.jsp">Thay đổi thông tin</a></li>
								<li><a class="dropdown-item" href="CustomerView/changePass.jsp">Đổi mật khẩu</a></li>
								<li><a class="dropdown-item" href="customer?customer_act=logout">Đăng xuất</a></li>
							</ul>
						</div>
					</div>
					<%
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div clasrs="carousel-inner">
						<div class="carousel-item active">
							<img src="public/images/slider/1.png" class="d-block w-100"
								alt="...">
						</div>
						<div class="carousel-item">
							<img src="public/images/slider/2.png" class="d-block w-100"
								alt="...">
						</div>
						<div class="carousel-item">
							<img src="public/images/slider/3.png" class="d-block w-100"
								alt="...">
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top"
								src="public/images/product/1.png" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top"
								src="public/images/product/2.png" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Áo thun Pro-S1</a>
								</h4>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top"
								src="public/images/product/3.png" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">Áo thun Pro-S1</a>
								</h4>
	...
	<div class="input-group mb-3">
		...
		<div class="form-floating">
			<input type="text" class="form-control" id="floatingInputGroup1"
				placeholder="Username"> <label for="floatingInputGroup1">Username</label>
		</div>
